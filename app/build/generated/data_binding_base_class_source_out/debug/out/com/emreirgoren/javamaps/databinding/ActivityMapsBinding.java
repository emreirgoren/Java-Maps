...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull ConstraintLayout rootView, @NonNull Button deleteButton,
      @NonNull EditText placeNameText, @NonNull Button saveButton) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapsBinding((ConstraintLayout) rootView, deleteButton, placeNameText,
          saveButton);
    }
